...
const steveJobs = require('./data/quotes/specific-people/steve-jobs.json')
...
app.get("/api/quotes/steve-jobs", function (req, res) {
  res.json({
    quote: `${steveJobs[Math.floor(Math.random() * steveJobs.length)]}`,
  });
});
